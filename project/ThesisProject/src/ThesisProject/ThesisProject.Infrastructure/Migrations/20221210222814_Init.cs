        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalculatedPrice = table.Column<decimal>(type: "decimal(2,2)", precision: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_OrderStatuses_OrderStatusType",
                        column: x => x.OrderStatusType,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderStatusType",
                table: "Orders",
                column: "OrderStatusType");
